...
- Các marker gần nghĩa như **provided that**, **as long as**, **in case** cũng thường mở đầu một mệnh đề điều kiện.
...
`.trim(),
  ...
  exercises: [
    {
      id: 'gram-08-ex01',
      question: 'If employees miss the safety drill, they _______ a follow-up session.',
      options: ['attend', 'will attend', 'would attend', 'would have attended'],
      correctAnswer: 0,
      explanation:
        'Đây là **zero conditional** vì câu diễn tả quy định chung của công ty. Cặp mẫu đúng là **if + present simple** (miss) và **present simple** (attend), nên chọn **attend**.',
    },
    {
      id: 'gram-08-ex02',
