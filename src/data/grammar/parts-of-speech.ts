  ...
  exercises: [
    {
      ...
      correctAnswer: 1,
      explanation: 'Clue: sau "The" và trước "of" là vị trí của danh từ. Correct part of speech: "development" là noun. Why others are wrong: "develop" là verb, "developing" là gerund/participle không tự nhiên ở đây, và "developer" chỉ người phát triển, không khớp với ý "quá trình phát triển".',
    },
    {
      id: 'gram-01-ex02',
      ...
      correctAnswer: 2,
      explanation: 'Clue: blank bổ nghĩa cho động từ "worked". Correct part of speech: "diligently" is an adverb. Why others are wrong: "diligent" is an adjective that must modify a noun, "diligence" is a noun, and "diligentness" is not the natural TOEIC form.',
    },
    {
      id: 'gram-01-ex03',
      ...
      correctAnswer: 0,
      explanation: 'Clue: the blank comes before the noun "answer". Correct part of speech: "quick" is an adjective. Why others are wrong: "quickly" is an adverb and cannot directly modify a noun here, "quicken" is a verb, and "quickness" is a noun, which would not fit before another noun.',
    },
    {
      id: 'gram-01-ex04',
      ...
      correctAnswer: 1,
      explanation: 'Clue: the blank modifies the verb phrase "was updated". Correct part of speech: "recently" is an adverb. Why others are wrong: "recent" is an adjective, "recentness" is a noun, and "recenter" is a verb that does not fit the passive structure.',
    },
    {
      id: 'gram-01-ex05',
      question: 'The team delivered a _______ economic forecast that reflected the company’s cost-cutting strategy.',
      options: ['economic', 'economical', 'economically', 'economy'],
      correctAnswer: 1,
      explanation: 'Clue: the blank comes before the noun "forecast", so it must be an adjective, and the meaning must match "cost-cutting strategy". Correct part of speech: "economical" is the adjective meaning cost-saving. Why others are wrong: "economic" means related to the economy but does not clearly express cost-saving, "economically" is an adverb and cannot modify a noun, and "economy" is a noun, so it cannot directly describe "forecast".',
    },
  ],
}
